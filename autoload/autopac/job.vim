...
" public apis {{{
function! autopac#job#start(cmd, opts) abort
    return s:job_start(a:cmd, a:opts)
endfunction

function! autopac#job#stop(jobid) abort
    call s:job_stop(a:jobid)
endfunction

function! autopac#job#send(jobid, data) abort
    call s:job_send(a:jobid, a:data)
endfunction

function! autopac#job#wait(jobids, ...) abort
